<?php
  ...
  if(isset($_POST["submit"]))
  {
    ...
    $sql = "SELECT * from admin_table where email ='$username' and phone ='$phone'";
    ...
    if($row) 
    {
        ...
        (
            ...
            <script language='JAVASCRIPT'>
                ...
                window.location.href='https://api.whatsapp.com/send/?phone=6".$phone."&text=http://localhost/SVS-GlobalBiz-Solution/admin-reset-password.php?phone=".$phone."';
            </script>
            "
        );
	}
...
<head>
    ...
    <title>Admin Forget Password | SVS GlobalBiz Solution</title>
