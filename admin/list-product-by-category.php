  ...
  { 
    ...
    (
      "<script language='JAVASCRIPT'>
          ...
          window.location.href='list-product-by-category.php';
      </script>"
    );
  }
...
<head>
  ...
  <title>List Product By Category Page | SVS GlobalBiz Solution</title>
  <!-- plugins:css -->
          ...
          <div class="row">
            <div class="col-md-12 grid-margin">
              <div class="d-flex justify-content-between align-items-center">
                <div>
                  <h4 class="font-weight-bold mb-0">List Product By Category</h4>
                </div> 
              </div>
            </div>
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                    ...
                    <table class="table table-bordered text-center">
                      ...
                      <?php
                        ...
                        $sql = "SELECT * FROM product_info_table  
                                ...
                                WHERE admin_id='$admin_id' AND product_category_table.category_id='$category_id'";
                  ...
                  <a href="view-product-by-category.php"><input type="button" class="btn btn-warning mr-2 text-light mt-2" value="Back"></a>
                </div>
              </div>
            </div> 
          </div>
