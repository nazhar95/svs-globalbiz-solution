...
<head>
  ...
  <title>View Product By Category Page | SVS GlobalBiz Solution</title>
  <!-- plugins:css -->
          ...
          <div class="row">
            <div class="col-md-12 grid-margin">
              <div class="d-flex justify-content-between align-items-center">
                <div>
                  <h4 class="font-weight-bold mb-0">View Product By Category</h4>
                </div> 
              </div>
            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <?php
                                    ...
                                    $sql = "SELECT DISTINCT product_category_table.category_id, product_category_table.product_category 
                                            FROM product_info_table LEFT JOIN product_category_table ON product_info_table.category_id = product_category_table.category_id 
                                            LEFT JOIN brand_table ON product_info_table.brand_id = brand_table.brand_id   
                                            WHERE admin_id='$admin_id' 
                                            ORDER BY product_category_table.category_id ASC";
                                    ...
                                    if (mysqli_num_rows($result) > 0) 
                                    {
                                      ...
                                      while($row = mysqli_fetch_assoc($result)) 
                                      {
                                        ...
                                        echo 
										'
                                            <a href="list-product-by-category.php?category_id='.$c_id.'" style="text-decoration:none;">
                                                <button type="button" class="btn" style="background-color:#CFB53B;color:white;width:150px;">'.$category.'</button>
                                            </a>  
                                        ';
