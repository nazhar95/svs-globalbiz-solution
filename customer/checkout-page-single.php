...
<head>
    ...
    <title>Single Item Checkout Page  | SVS GlobalBiz Solution</title>
    <!-- plugins:css -->
        ...
        <div class="main-panel">
            ...
            <div class="row">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                    <h4 class="font-weight-bold mb-0">Confirm Details</h4>
                    </div> 
                </div>
                </div>
                            ...
                            while($row = mysqli_fetch_assoc($result)) 
                            {
                                ...
                                '  
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="product_name" value="'.$product_name.'" readonly>
                                        <input type="hidden" name="product_id" value="'.$product_id.'">
                                    </div>
                                    <div class="form-group">
                                        <label><b>Quantity</b></label>
                                        <input class="form-control" name="quantity" value="'.$quantity.'" readonly>
                                    </div>
                                    <div class="form-group">
                                        <label><b>Total Price</b></label>
                                        <input class="form-control" name="total_price" value="'.$total_price.'" readonly>
                                    </div>
