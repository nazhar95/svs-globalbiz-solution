<?php
    ...
    if(isset($_POST['update_profile']))
    {
        ...
        else
        {
            ...
            $user_check_query = "SELECT * FROM customer_table WHERE email='$email' AND customer_id='$customer_id' LIMIT 1";
            ...
            if($password1 == $password2)
            {
                ...
                $update_profile_query = "UPDATE customer_table SET full_name='$full_name', email='$email', password='$password', gender='$gender', address='$address', phone='$phone', dob='$dob' WHERE customer_id='$customer_id'";        
                ...
                (
                    "<script language='JAVASCRIPT'>
                        ...
                        window.location.href='customer-profile-setting.php';
                    </script>"
                );
        ...
        <div class="main-panel">
            ...
            <div class="row">
                ...
                <div class="card">
                    ...
                    <?php
                        $customer_id=$_SESSION['customer_id'];
                        $select_details_query="SELECT * FROM customer_table WHERE customer_id='$customer_id'";
                        ...
                        if (mysqli_num_rows($result) > 0) 
                        {
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                <input name="full_name" value="'.$row['full_name'].'" type="text" placeholder="Please enter your full name" class="form-control" min="10" max="200" required/>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                <textarea name="address" id="" cols="30" rows="5" placeholder="Please enter your address" min="10" max="300" class="form-control" required/>'.$row['address'].'</textarea>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                <input type="date" class="form-control" placeholder="Data of Birth" name="dob" id="dob" value="'.$row['dob'].'">
                                </div>
                            </div>
                            <div class="form-group row">
